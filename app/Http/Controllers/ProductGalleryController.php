...
// use App\Http\Requests\ProductGallery;
...
class ProductGalleryController extends Controller
{
    ...
    public function store(ProductGalleryRequest $request)
    {
        ...
        $items = ProductGallery::create($data)->orderBy('id', 'DESC');
        return redirect()->route('product-galleries.index', compact('items'));
    }
    ...
    {
        $items = ProductGallery::where('id', $id)->first();
